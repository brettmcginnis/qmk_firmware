...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  LCTL_T(KC_ESC), LOPT_T(KC_NO), LCMD_T(KC_NO), LSFT_T(KC_NO), _______, _______, _______, _______,KC_LEFT, KC_DOWN, KC_RIGHT, KC_ENTER,
...
[3] = LAYOUT_preonic_grid(
  _______, KC_MEDIA_PREV_TRACK, KC_MPLY, KC_MEDIA_NEXT_TRACK, _______, _______, _______, KC_F1, KC_F2, KC_F3, KC_F4, KC_BSPC,
